...
function setup() {
	...
	//Crie os Corpos aqui.
    fill("red")
	plane = Bodies.rectangle(200,height-60,width,20,plane_options);
	World.add(world,plane);

	ball = Bodies.circle(550,10,20,ball_options);
  World.add(world,ball);
  ball1 = Bodies.circle(550,10,20,ball_options);
  World.add(world,ball1);
  ball2 = Bodies.circle(550,10,20,ball_options);
